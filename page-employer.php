                        ...
                        <div class="row">
                            <div class="block-region-top-wrapper">
                                <div class="block-region-top">
                                    <div class="block block-block-content block-block-content4b20beaf-6eab-4a2a-bd93-ff4051ff02bd">
                                        <div class="node-header-premium">
                                    ...
                                    <div class="block block-block-content block-block-content5abab5f6-2e8f-44ef-8f0d-857925d7a031 block-left">
                                        <div class="gallery-wrapper">
										    <ul class="gallery">
										        ...
										        <li class="item-2"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/placeit-19.jpg" width="570" height="600" alt="" class="image-style-premium-box">
										        </li>
										    </ul>
										</div>
                                        <div class="content">
...
FEATURED JOB SLOTS</h2>
                                            ...
                                            <div class="clearfix text-formatted field field--name-field-premium-box-percents field--type-text-long field--label-hidden field__items">
                                                <div class="field__item">
                                                    ...
                                                    <p>of users view a job after viewing a premium company profile</p>
                                                </div>
                                                <div class="field__item">
                                                    <p><strong>5k+</strong></p>
                                                    <p>users create job alerts
                                                        <br> after viewing premium
                                                        <br> profiles each month</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="block block-block-content block-block-content60942300-17d0-472d-a7c7-d215379d245a block-right">
                                        <div class="gallery-wrapper">
										    <ul class="gallery">
										        <li class="item-1"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/placeit-20_0.jpg" width="570" height="600" alt="" class="image-style-premium-box">
										        </li>
										        <li class="item-2"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/screen-shot-2017-03-21-at-12-26-16-pm_0.jpg" width="570" height="600" alt="" class="image-style-premium-box">
										        </li>
										        <li class="item-3"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/screen-shot-2017-03-21-at-12-12-09-pm_0.jpg" width="570" height="600" alt="" class="image-style-premium-box">
										        </li>
										    </ul>
										</div>
                                        <div class="content">
...
COMMUNITY EVENTS</h2>
                                            ...
                                            <div class="clearfix text-formatted field field--name-field-premium-box-percents field--type-text-long field--label-hidden field__items">
                                                <div class="field__item">
                                                    ...
                                                    <p>of users view a job
                                                        <br> after reading
                                                        <br> our content</p>
                                                </div>
                                                <div class="field__item">
                                                    <p><strong>32%</strong></p>
                                                    <p>of users view a company
                                                        <br> profile after reading
                                                        <br> our content</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="block block-block-content block-block-content34483675-9f8b-4edd-8c82-41666b4e213d block-left">
                                        <div class="gallery-wrapper">
										    <ul class="gallery">
										        <li class="item-1"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/placeit-21.jpg" width="570" height="600" alt="placeit" class="image-style-premium-box">
										        </li>
										        <li class="item-2"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/placeit-3-copy.jpg" width="570" height="600" alt="placeit" class="image-style-premium-box">
										        </li>
										    </ul>
										</div>
                                        <div class="content">
                                            ...
                                            <div class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                                <h2>SOURCING DATABASE<br>
WEEKLY JOB EMAILS</h2>
                                                <p>Source active candidates with specialized skillsets through our curated opt-in database. Our personalized newsletters and social channels drive targeted candidates back to your job slots.&nbsp;</p>
                                            </div>
                                            <div class="clearfix text-formatted field field--name-field-premium-box-percents field--type-text-long field--label-hidden field__items">
                                                <div class="field__item">
                                                    <p><strong>10k+&nbsp;</strong></p>
                                                    <p>candidates in our
                                                        <br> opt-in database</p>
                                                </div>
                                                <div class="field__item">
                                                    <p><strong>35%</strong></p>
                                                    <p>job seeker email
                                                        <br> introduction acceptance rate</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="boston block block-block-content block-block-contente6d444ad-37b3-4083-a27d-f34e9e4c6f80">
                                        <div class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                    ...
                                    <div class="block block-block-content block-block-content7de5294b-7423-473e-9cfd-fa34f852a1fe">
                                        ...
                                        <div class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                            ...
                                            <div class="item premium-category-it-ops"><span>13%</span>
                                                <br> IT + OPS</div>
                                            <div class="item premium-category-analytics"><span>14%</span>
                                                <br> Analytics
                                            </div>
                                            <div class="item premium-category-developer"><span>17%</span>
                                                <br> Developer
                                            </div>
                                            <div class="item premium-category-design"><span>3%</span>
                                                <br> Design + UX</div>
                                            <div class="item premium-category-marketing"><span>9%</span>
                                                <br> Marketing
                                            </div>
                                            <div class="item premium-category-product"><span>4%</span>
                                                <br> Product
                                            </div>
                                            <div class="item premium-category-sales"><span>22%</span>
                                                <br> Sales
                                            </div>
                                            <div class="item premium-category-project-mgmt"><span>9%</span>
                                                <br> Project MGMT</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="block block-block-content block-block-content719cdaa4-5cda-4394-9005-91cb0edbb7b3">
                                        ...
                                        <div class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
                                            <div class="partner partner-acquia"><span>Acquia</span></div>
